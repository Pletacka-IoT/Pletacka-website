...
class SensorOverviewFactory
{
    ...
    {
        return new SensorOverview($this->multiSensorsManager, $this->thisSensorManager, $this->database, $this->databaseSelectionManager, $this->workShiftManager);
    }
}